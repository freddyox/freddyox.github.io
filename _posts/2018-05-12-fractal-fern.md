...
The idea is not mine, but is summarized
...
may be seen by the Figure on the right; the fern is generated by starting with some initial
...
assigning colors to the fern. Note that this fern does not look exactly the same as Fig. 1. The
ferns in Fig. 1 are generated using the perscription found
...
<p></p>
 <figure>
  ...
  <figcaption>Fig. 4 - An animation of the fern seen in Fig. 1 in
