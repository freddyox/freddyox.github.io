...
<p></p>
 <figure>
  <img src="/images/tree_fractal/assortment_nsplits_small_white_new.png" alt="" height="100%" width="100%">
  <figcaption>Fig. 2 - Going clockwise and starting at the top left, the number of branches
  to generate at a new node is 2, 3, 4, 5, and 9. The trunk length and branch ratio relative
  to the trunk have been adjusted to get a decent picture (hence why GUI widgets
  are wonderful for this project).</figcaption>
</figure>
<p></p>
