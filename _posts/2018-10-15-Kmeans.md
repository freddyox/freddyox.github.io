...
short $$(\lesssim 3$$ min$$)$$ or long $$(\gtrsim 3$$ min$$)$$, which means that we have to wait a
...
<figure>
  ...
  <figcaption>Fig. 3 - Applying K-means (using Python's scikit-learn) to Old Faithful data.
